...
function findAllPSiblings(where) {
  const childElems = [].slice.call(where.children);

  return childElems.filter((elem) => elem.nextElementSibling && elem.nextElementSibling.tagName === 'P');
}
...
function deleteTextNodes(where) {
  const childElems = where.childNodes;
